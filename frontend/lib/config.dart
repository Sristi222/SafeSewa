...
class ApiService {
  static const String _apiUrl = 'http://192.168.1.9:3000/api/flood-alerts';
...
final url = 'http://192.168.1.9:3000/';//http://100.64.216.142:3000/
// ignore: prefer_interpolation_to_compose_strings
final registration = url + "registration";
// ignore: prefer_interpolation_to_compose_strings
final login = url + "login";

const String baseUrl = "http://192.168.1.9:3000/api";
